...
public class init implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Member member3 = new Member(3L, "dlwodnjs1", passwordEncoder.encode("dlwodnjs1"), MemberRoleEnum.SELLER, 100000, "010-1322-3250", "이재원");
        memberRepository.save(member3);
        Member member4 = new Member(4L, "gjtjdxo1", passwordEncoder.encode("gjtjdxo1"), MemberRoleEnum.SELLER, 100000, "010-4222-3959", "허성태");
        memberRepository.save(member4);

        Member member5 = new Member(5L, "gjwjdan1", passwordEncoder.encode("gjwjdan1"), MemberRoleEnum.CUSTOMER, 100000, "010-7122-3057", "허정무");
        memberRepository.save(member5);
        Member member6 = new Member(6L, "gksquddus1", passwordEncoder.encode("gksquddus1"), MemberRoleEnum.CUSTOMER, 100000, "010-7122-7357", "한병연");
        memberRepository.save(member6);

        Member member7 = new Member(7L, "kiang18", passwordEncoder.encode("kiang18"), MemberRoleEnum.ADMIN, 100000, "010-6122-3357", "김지환");
        memberRepository.save(member7);

        Member member8 = new Member(8L, "kiang970418", passwordEncoder.encode("kiang970418"), MemberRoleEnum.CUSTOMER, 100000, "010-5122-3857", "김필립");
        memberRepository.save(member8);

        Member member9 = new Member(9L, "qkrtpdls1", passwordEncoder.encode("qkrtpdls1"), MemberRoleEnum.SELLER, 100000, "010-1422-3157", "박세인");
        memberRepository.save(member9);
        Member member10 = new Member(10L, "qowlsdk1", passwordEncoder.encode("qowlsdk1"), MemberRoleEnum.SELLER, 100000, "010-1322-3327", "배진아");
        memberRepository.save(member10);

        Member member11 = new Member(11L, "rladudgks1", passwordEncoder.encode("rladudgks1"), MemberRoleEnum.CUSTOMER, 100000, "010-1829-3157", "김영한");
        memberRepository.save(member11);
        Member member12 = new Member(12L, "clfemfjs1", passwordEncoder.encode("clfemfjs1"), MemberRoleEnum.CUSTOMER, 100000, "010-1029-3150", "칠드런");
        memberRepository.save(member12);

        Member member13 = new Member(13L, "rlarhksghks1", passwordEncoder.encode("rlarhksghks1"), MemberRoleEnum.SELLER, 100000, "010-1122-3351", "김관한");
        memberRepository.save(member13);
        Member member14 = new Member(14L, "qkrtmfrl1", passwordEncoder.encode("qkrtmfrl1"), MemberRoleEnum.SELLER, 100000, "010-1122-3535", "박슬기");
        memberRepository.save(member14);
        Member member15 = new Member(15L, "dbswjdtn1", passwordEncoder.encode("dbswjdtn1"), MemberRoleEnum.SELLER, 100000, "010-1122-3354", "윤정수");
        memberRepository.save(member15);
        Member member16 = new Member(16L, "rlatmddus1", passwordEncoder.encode("rlatmddus1"), MemberRoleEnum.SELLER, 100000, "010-1122-4351", "김승연");
        memberRepository.save(member16);

        Member member17 = new Member(17L, "rhkrdbsrl1", passwordEncoder.encode("rhkrdbsrl1"), MemberRoleEnum.CUSTOMER, 100000, "010-1122-3452", "곽윤기");
        memberRepository.save(member17);
        Member member18 = new Member(18L, "wlsdnxk1", passwordEncoder.encode("wlsdnxk1"), MemberRoleEnum.SELLER, 100000, "010-2120-3355", "진우타");
        memberRepository.save(member18);
        Member member19 = new Member(19L, "whtjdfkr1", passwordEncoder.encode("whtjdfkr1"), MemberRoleEnum.CUSTOMER, 100000, "010-1192-3158", "조성락");
        memberRepository.save(member19);
        Member member20 = new Member(20L, "thstjrrn1", passwordEncoder.encode("thstjrrn1"), MemberRoleEnum.SELLER, 100000, "010-1822-2357", "손석구");
        memberRepository.save(member20);
        Member member21 = new Member(21L, "rlaxodl1", passwordEncoder.encode("rlaxodl1"), MemberRoleEnum.CUSTOMER, 100000, "010-1172-3357", "김태이");
        memberRepository.save(member21);
        Member member22 = new Member(22L, "rlawhdals1", passwordEncoder.encode("rlawhdals1"), MemberRoleEnum.CUSTOMER, 100000, "010-1162-4354", "김종민");
        memberRepository.save(member22);
        Member member23 = new Member(23L, "rkdghehd1", passwordEncoder.encode("rkdghehd1"), MemberRoleEnum.SELLER, 100000, "010-1522-3556", "강호동");
        memberRepository.save(member23);
        Member member24 = new Member(24L, "skarndtjd1", passwordEncoder.encode("skarndtjd1"), MemberRoleEnum.CUSTOMER, 100000, "010-1422-7356", "남궁성");
        memberRepository.save(member24);
        Member member25 = new Member(25L, "qorrltjs1", passwordEncoder.encode("qorrltjs1"), MemberRoleEnum.SELLER, 100000, "010-1322-7357", "백기선");
        memberRepository.save(member25);
        Member member26 = new Member(26L, "wjvkfrp1", passwordEncoder.encode("wjvkfrp1"), MemberRoleEnum.CUSTOMER, 100000, "010-1222-3857", "저팔게");
        memberRepository.save(member26);
        Member member27 = new Member(27L, "chzhvkdl1", passwordEncoder.encode("chzhvkdl1"), MemberRoleEnum.CUSTOMER, 100000, "010-1122-9358", "초코파이");
