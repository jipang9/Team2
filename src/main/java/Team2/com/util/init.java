...
public class init implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        // 판매자 pk : 3,4,8,9,13,14,15,16,18,19,23,25 (12명)
        // 관리자 pk : 7
        // 고객 pk : 1,2,5,6,7,10,11,12,17,20,21,22,24,26,27 (14명)

        // 권한 UP : 1, 5, 6, 11 ,17, 19, 21 ( 7명 )
        ...
        Item item2 = new Item("갤럭시 Z 플립", "주운거임", member8, 300000, 1);
        itemRepository.save(item2);
        Item item3 = new Item("컴파일러의 이해", "으악으악으악", member25, 18000, 3);
        itemRepository.save(item3);
        Item item4 = new Item("달팽이 껍질", "한약재료", member19, 300, 300);
        itemRepository.save(item4);
        Item item5 = new Item("스포아의 포자", "동충하초", member19, 180, 150);
        itemRepository.save(item5);
        Item item6 = new Item("빨간 달팽이의 점액", "피부미용에 좋다", member19, 80, 25);
        itemRepository.save(item6);
        Item item7 = new Item("스카치 캔디", "맛있다", member8, 200, 500);
        itemRepository.save(item7);
        Item item8 = new Item("먹다남은 초코파이", "한입하시죠", member14, 600, 111);
        itemRepository.save(item8);
        Item item9 = new Item("데이터베이스 개론", "전공필수", member16, 22500, 3);
        itemRepository.save(item9);
        Item item10 = new Item("하리보 젤리", "이섞는다", member18, 3000, 5);
        itemRepository.save(item10);
        Item item11 = new Item("곰팡이 핀 햄버거", "맛있겠다", member14, 6800, 3);
        itemRepository.save(item11);
        Item item12 = new Item("자바의 정석", "교양서적", member8, 23500, 1);
        itemRepository.save(item12);
        Item item13 = new Item("포카칩 파란색", "취향존중", member19, 2500, 30);
